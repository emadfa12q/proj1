...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void seedSettings(SQLiteDatabase db) {
        putSetting(db, "theme", "dark");
        putSetting(db, "auto_track", "true");
        putSetting(db, "idle_limit_seconds", String.valueOf(TimeUtils.DEFAULT_IDLE_LIMIT_MS / 1000));
    }
